...
export const createNewData = (formData) => async (dispatch, getState) => {
    try {
        ...
        let { data } = await axios.post(`https://backend-final-2-ahds.onrender.com/ashirwad/mendhepathar/new`, formData, config);
        dispatch({
...
export const getAllData = () => async (dispatch, getState) => {
    try {
        ...
        let { data } = await axios.get(`https://backend-final-2-ahds.onrender.com/ashirwad/mendhepathar/get`);
        dispatch({
...
export const deleteData = (id) => async (dispatch, getState) => {
    try {
        ...
        let { data } = await axios.delete(`https://backend-final-2-ahds.onrender.com/ashirwad/mendhepathar/remove/${id}`);
        dispatch({
...
export const UpdateData = (id, updatedData) => async (dispatch) => {
    ...
    try {
        ...
        let { data } = await axios.put(`https://backend-final-2-ahds.onrender.com/ashirwad/mendhepathar/update/${id}`, updatedData, config);
        dispatch({
...
export const getDetails = (id) => async (dispatch) => {
    try {
        ...
        let { data } = await axios.get(`https://backend-final-2-ahds.onrender.com/ashirwad/mendhepathar/details/${id}`);
